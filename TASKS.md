...
- [ ] **T2.1 Countries data model and loader.** Types for §4.1, a loader from JSON, and the §4.1 validation as a function with tests (a valid sample passes; each rule has a failing sample).
