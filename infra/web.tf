# The site and the API behind one CloudFront distribution (SPEC.md §6):
...
resource "aws_cloudfront_distribution" "site" {
  ...
  # The UI uses hash routes (#/passport), so no SPA fallback is needed; that
  # also keeps API 404s from being rewritten into index.html.
